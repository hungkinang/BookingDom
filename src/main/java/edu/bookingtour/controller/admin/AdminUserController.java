...
public class AdminUserController {
    ...
    @GetMapping
    public String listUsers(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "5") int perPage,
            Model model) {
    ...
    public String updateUser(@PathVariable Integer id, NguoiDung user, Model model) {
        try {
    ...
    public String showDetailUser(@PathVariable Integer id,
        ...
        Page<edu.bookingtour.entity.DatCho> bookingPage = datChoRepository.findByIdNguoiDung(user,
